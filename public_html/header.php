...
<li class="dropdown">
<a href="profile.html" class="dropdown-toggle user-link" data-toggle="dropdown" title="">
  <span class="user-img"><img class="img-circle" src="../assets/img/user.jpg" width="40" alt="photo">
  <span class="status online"></span></span>
  <span><?php echo strtoupper($_SESSION['uname']);?></span>
  <i class="caret"></i>
</a>
